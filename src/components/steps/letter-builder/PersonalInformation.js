        ...
        return (<React.Fragment>
            ...
            <div className={classes.demo}>
                ...
                <TextField id="lastName" label="Last Name" value={state.lastName} onChange={handleChange}
                           variant="outlined"/>
                <TextField id="address" label="Current Address" value={state.address} onChange={handleChange}
                           variant="outlined"/>
                <TextField id="unit" label="Unit (optional)" value={state.unit} onChange={handleChange}
                           variant="outlined"/>
                <TextField id="city" label="City" value={state.city} onChange={handleChange} variant="outlined"/>
                <FormControl variant="outlined">
                    <InputLabel id="state-label">State</InputLabel>
                    <Select labelId="state-select" id="state" value={state.state} onChange={handleStateChange}
                            autoWidth>
